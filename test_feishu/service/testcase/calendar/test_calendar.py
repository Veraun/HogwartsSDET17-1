...
from test_feishu.service.testcase.calendar.base_calendar_testcase import BaseCalendarsTestCase
from test_feishu.service.utils import Utils

list_normal_data = Utils.load_yaml("../../data/calendar/list.yml", "normal")
create_normal_data = Utils.load_yaml("../../data/calendar/create.yml", "normal")
update_normal_data = Utils.load_yaml("../../data/calendar/update.yml", "normal")


if __name__ == '__main__':
    print("list_normal_data：", list_normal_data)
